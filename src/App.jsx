...
const RunaDataMatcher = () => {
  ...
  // Función para generar nombres de columnas estilo Excel (A, B, C, ..., AA, AB, etc.)
  ...
  const processData = () => {
    ...
    const baseIdCol = 0; // Primera columna del archivo base
  ...
  const openIndependentPreview = (data, title) => {
    ...
    setIndependentPreviews(prev => [...prev, newPreview]);
  };
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300 text-sm">
                    <thead className="sticky top-0 bg-gray-100">
                      <tr>
                        <th className="border border-gray-300 p-2 text-left text-xs font-bold bg-blue-50">
                          #
                        </th>
                        {previewData.data[0]?.map((header, index) => (
                          <th key={index} className="border border-gray-300 p-2 text-left text-xs font-bold bg-blue-50 min-w-[100px]">
                    ...
                    <tbody>
                      {previewData.data.slice(1).map((row, rowIndex) => (
                        <tr key={rowIndex} className={rowIndex % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          <td className="border border-gray-300 p-2 text-xs font-medium text-gray-500 bg-gray-100">
                            {rowIndex + 1}
                          </td>
